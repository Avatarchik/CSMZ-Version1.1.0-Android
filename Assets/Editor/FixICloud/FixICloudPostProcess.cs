...
public class FixICloudPostProcess : MonoBehaviour {
	
	private static string processName = "FixICloud";
	...
	public static void OnPostProcessBuild(BuildTarget target, string path)
	{
		if (target == BuildTarget.iPhone) {
			...
			pythonProcess.StartInfo.Arguments = string.Format("Assets/Editor/FixICloud/add_icloud_xcode.py \"{0}\" \"{1}\"", path, objCPath);
