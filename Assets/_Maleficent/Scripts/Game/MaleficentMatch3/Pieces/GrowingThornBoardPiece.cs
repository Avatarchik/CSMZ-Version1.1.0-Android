...
public class GrowingThornBoardPiece : Match3BoardPiece {
	...
	public override void Awake ()
	{
		...
		backModelRenderer = transform.FindChild("Model_back").GetComponent<Renderer>() as SpriteRenderer;
		emberAnimation = transform.FindChild("Model_front").GetComponent<Animation>();
		Burned = false;
	}
